                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody>
                                @foreach ($reportesIngresos as $reporte)
                                    <tr>
                                        <th scope="row"><button class="btn btn-default btn-sm" href="#">{{ $reporte->reporteTrimestral->trimestre->nombre . "/" . $reporte->reporteTrimestral->año . " " . $reporte->reporteTrimestral->seccional->nombre  }}</button></th>
                                        <td>{{ $reporte->total_provincial }}</td>
                                        <td>{{ $reporte->coparticipacion }}</td>
                                        <td>{{ $reporte->total_general }}</td>
                                        <td><button class="btn btn-default btn-sm" href="#">Ver Detalles</button></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
